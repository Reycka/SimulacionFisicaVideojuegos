...
Particle::Particle(Vector3 pos, PxShape* shape, const Vector4& color, Vector3 _v, double _tVida, double _damp,double masaSim,double VolSim) : Entity(pos,shape,color,_v,masaSim,VolSim,_tVida,_damp)
{
