...
class SolidRigidGaussianGenerator : SolidRigidGenerator
{
private:
	std::normal_distribution<double> nd;
public:
	SolidRigidGaussianGenerator(float rad,float _timeToSpawn,float l, physx::PxReal coefStatic, physx::PxReal dynamStatic, physx::PxReal restitution, physx::PxPhysics* gPhysx, physx::PxGeometry geom, Vector3 pos, const Vector4& color, Vector3 _v, double _masa, double vol, double _tVida, double _damp = 0.999);
