...
{
	PxReal coef = 0.4;
	AddEntity(new nave(_gScene, coef, coef / 2, coef * 2, _phy, PxSphereGeometry(3), Vector3(0.0, 40.0, 0.0),
		Vector4(1.0, 0.0, 1.0, 1.0), Vector3(1.0, 0.0, 0.0), 5, 2, 5.0,getCamera()->getTransform()));
}
...
void gameScene::createForces()
{
	...
	whirlWind = new WhirlwindGenerator({ 0.0,30.0,0.0 }, 70.0f, 10);
