...
public:
	GaussianGenerator(float rad,Vector3 pos, physx::PxShape* shape,Vector4 color, Vector3 v, double _tVida, Vector3 g = { 0.0,-9.8,0.0 },int l = 10, double timeToSpwan = 5, double damp = 0.999);
